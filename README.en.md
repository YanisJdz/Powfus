...
[![Download](https://img.shields.io/badge/Download-Powfus_1.2.2-e83fb0?style=for-the-badge)](../../releases/latest)
...
1. **Download** the `Powfus-1.2.2.msi` file from the [releases page](../../releases/latest).
