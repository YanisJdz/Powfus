...
[![Télécharger](https://img.shields.io/badge/Télécharger-Powfus_1.4.1-e83fb0?style=for-the-badge)](../../releases/latest)
...
- 🎨 **5 thèmes** et une interface qui va à l'essentiel ;
...
1. **Télécharge** le fichier `Powfus-1.4.1.msi` depuis la [page des releases](../../releases/latest).
