...
[![Télécharger](https://img.shields.io/badge/Télécharger-Powfus_1.1.0-e83fb0?style=for-the-badge)](../../releases/latest)
...
1. **Télécharge** le fichier `Powfus-1.1.0.msi` depuis la [page des releases](../../releases/latest).
